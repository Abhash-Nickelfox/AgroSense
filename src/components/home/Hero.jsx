  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <div
          className="bg-cover bg-bottom w-full h-full cinematic-zoom"
          style={{ backgroundImage: `url('${HERO_IMAGE}')` }}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest/65 via-surface-container-lowest/25 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-r from-surface-container-lowest/75 via-surface-container-lowest/35 to-transparent w-3/5" />
      </div>
      ...
      <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full grid grid-cols-1 md:grid-cols-12 gap-gutter">
        <div className="md:col-span-7 flex flex-col justify-center">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-primary text-white px-8 py-4 rounded-lg font-body-md hover:bg-on-primary-fixed-variant transition-colors flex items-center gap-2">
